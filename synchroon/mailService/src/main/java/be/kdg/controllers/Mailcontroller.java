...
public class Mailcontroller
{
    ...
    {
        mailService.writeToFile(new Timestamp(System.currentTimeMillis()) + ": Mailservice enter");
        ...
        mailService.writeToFile( new Timestamp(System.currentTimeMillis()) + ": Mailservice has finished");
