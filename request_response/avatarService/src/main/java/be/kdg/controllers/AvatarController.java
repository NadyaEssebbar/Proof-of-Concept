...
public class AvatarController
{
   ...
   @RequestMapping(value = "/avatars", method = RequestMethod.POST)
    ...
    {
        avatarService.writeToFile( new Timestamp(System.currentTimeMillis()) + ": Avatarservice enter");
        ...
        avatarService.writeToFile( new Timestamp(System.currentTimeMillis()) + ": Avatarservice has finished");
    }
